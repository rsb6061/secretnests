...
Only one legacy hotel currently has a booking URL. The repo includes npm run check:booking-links for network validation. Future booking inventory belongs in the hotel_booking_links provider layer.
