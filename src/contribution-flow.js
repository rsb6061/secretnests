...
export async function addTripPage(request,env,ui){
  ...
  return ui.page(ui.shell(body),env,{title:"Add Your Trip | SecretNests",description:"Submit a first-party hotel stay to SecretNests.",canonical:"/add-your-trip",robots:"noindex,follow"});
}
